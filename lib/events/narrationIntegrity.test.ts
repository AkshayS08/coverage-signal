      ...
      results: [
        {
          ...
          needType: "credit",
          confidence: 0.95,
          citations: [{ form: "10-Q", date: "2026-07-28", reportDate: "", url: "https://example.com/synthetic" }],
          quoteVerified: true,
...
// happen to have bound figures in a given fixture rebuild. ---
{
  ...
  const headlineFact: VerifiedFact = {
    ...
    dates: ["2027"],
    sourceFiling: null,
    citations: [{ form: "10-Q", date: "2026-07-01", reportDate: "", url: "https://example.com/synthetic-headline" }],
  ...
  const otherFact: VerifiedFact = {
    ...
    dates: [],
    sourceFiling: null,
    citations: [{ form: "10-Q", date: "2026-07-01", reportDate: "", url: "https://example.com/synthetic-other" }],
...
// (asset-sale, etc., untouched). ---
{
  ...
  const debtMaturity: VerifiedFact = {
    ...
    citations: [{ form: "8-K", date: "2026-04-30", reportDate: "", url: "https://example.com/synthetic-hca-debt-maturity-8k" }],
...
// convention. ---
{
  ...
  const issuanceFact: VerifiedFact = {
    ...
    dates: ["2032"],
    sourceFiling: null,
    citations: [{ form: "8-K", date: "2025-11-18", reportDate: "", url: "https://example.com/synthetic-issuance-8k" }],
  ...
  const headlineFact: VerifiedFact = {
    ...
    dates: ["November 2027"],
    sourceFiling: null,
    citations: [{ form: "10-Q", date: "2026-06-30", reportDate: "", url: "https://example.com/synthetic-headline-10q" }],
