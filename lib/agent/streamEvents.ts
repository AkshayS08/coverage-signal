...
import type { DraftedBriefing } from "../rank/briefing";
 ...
 * plus its Sonnet-drafted (or template-fallback) briefing when it's a CALL.
 */
export type RunStreamEvent =
  | { type: "trace"; company: string; text: string }
  | { type: "result"; result: CompanyResult; briefing?: DraftedBriefing }
